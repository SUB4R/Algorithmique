...
hello();
// Ecrire une fonction qui prend un parametre et qui affiche Bonjour [Le prenom passé en parametre]
function helloYou(name) {
    return 'Bonjour ' + name;
}

let hello3 = helloYou('Subar');
console.log(hello3);
...
let squareperimeter2 = perimeter(65257);
...
// Transformez la fonction pour la rendre parametrable et pouvoir decider jusqu'a quel nombre la boucle se fait 

function numberpair (count){
...
// Je veux pouvoir decider du pas de la loop en plus
function numberpair (count, step){
...
On peut créer un tableau en utilisant des [] et en y insérant les éléments séparés par des virgules
*/
let sunday = 'dimanche'
let week = ['lundi' ,
  'mardi',
...
// On peut acceder a un element du tableau en utilisant son index numerique (indice)
// L'index du premier element commence est toujours 0 
console.log(week[7][0]); 
...
console.log(animaux [0], animaux [5])
...
//      AFFICHE tous les element du tableau animal

function displayArrayAnimaux(){
    for(let i = 0 ; i< animaux.length ; i++  ){
        console.log(animaux[i]);
}
}

displayArray(animaux);
...
displayArrayWithParameter(animaux);
